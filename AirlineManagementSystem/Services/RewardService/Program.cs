...
await eventConsumer.SubscribeAsync<RewardEarnedEvent>(async e =>
{
    using var handlerScope = scopeFactory.CreateScope();
    var rewardService = handlerScope.ServiceProvider.GetRequiredService<IRewardService>();
    await rewardService.HandleRewardEarnedAsync(e);
});
